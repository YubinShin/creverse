...
-- CreateIndex
CREATE INDEX "idx_http_log_created_at" ON "public"."http_log"("created_at");

-- CreateIndex
CREATE INDEX "idx_http_log_uri" ON "public"."http_log"("uri");

-- CreateIndex
CREATE INDEX "idx_http_log_trace" ON "public"."http_log"("trace_id");
